...
export default function BlogLocalSEOPage() {
...
<header data-screen-label="Post hero" style={{"padding": "clamp(64px,8vw,120px) clamp(24px,6vw,96px) clamp(36px,4.5vw,56px)"}}>
  ...
  <p data-rv data-rvd="2" style={{"fontSize": "clamp(15px,1.35vw,18px)", "lineHeight": "1.65", "margin": "clamp(20px,3vh,32px) 0 0", "maxWidth": "58ch", "color": "color-mix(in srgb, var(--color-text) 72%, transparent)"}}>“Near me” searches are the cheapest growth channel most businesses ignore. The basics, done properly, beat tricks.</p>
</header>
...
<article data-screen-label="Article" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(48px,6vw,90px) clamp(24px,6vw,96px)"}}>
  <div style={{"maxWidth": "820px"}}>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "0 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>01</span>Own your Google Business Profile</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>Complete every field, add current photos, keep hours accurate. It is the first impression for most local searches, and it is free.</p>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "40px 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>02</span>Reviews are ranking fuel</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>Steady, genuine reviews signal relevance. Ask at the moment of delight, and reply to every one, good or bad.</p>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "40px 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>03</span>Build pages for real searches</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>A page per service and per area answers exactly what people type. Write plainly; search engines reward clarity.</p>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "40px 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>04</span>Speed wins on mobile</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>Local searches happen on phones. A fast, tidy mobile site keeps the visit, and the ranking.</p>
    <div data-rv style={{"marginTop": "44px", "borderTop": "2px solid var(--color-accent)", "background": "var(--color-surface)", "padding": "clamp(20px,2.6vw,32px)"}}>
      ...
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Update your profile weekly</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Ask for reviews consistently</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>One page per service</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Test your site on 4G</span></div>
    </div>
  </div>
</article>
<section data-screen-label="Pager" style={{"borderTop": "2px solid var(--color-divider)", "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(280px,1fr))", "gap": "2px", "background": "var(--color-divider)"}}>
  <a href="blog-hoardings.html" style={{"background": "var(--color-bg)", "textDecoration": "none", "padding": "clamp(24px,3.5vw,40px) clamp(24px,6vw,96px)", "transition": "background .3s"}} className="hv-24">
  ...
  <a href="blog-grid.html" style={{"background": "var(--color-bg)", "textDecoration": "none", "padding": "clamp(24px,3.5vw,40px) clamp(24px,6vw,96px)", "textAlign": "right", "transition": "background .3s"}} className="hv-24">
    ...
    <span style={{"display": "block", "fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(16px,1.7vw,22px)", "letterSpacing": "-.015em", "marginTop": "8px", "color": "var(--color-text)"}}>Building an Instagram grid people remember</span>
  </a>
</section>
