...
export default function BlogTrustPage() {
...
<header data-screen-label="Post hero" style={{"padding": "clamp(64px,8vw,120px) clamp(24px,6vw,96px) clamp(36px,4.5vw,56px)"}}>
  <div data-rv style={{"fontSize": "11px", "letterSpacing": ".22em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)", "marginBottom": "clamp(18px,3vh,30px)"}}><a href="blog.html" style={{"color": "inherit", "textDecoration": "none"}}>The Blog</a> · Branding · Jun '26 · 5 min read</div>
  <h1 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(30px,4.6vw,72px)", "lineHeight": "1.04", "letterSpacing": "-.024em", "margin": "0", "maxWidth": "24ch"}}>
    <span style={{"display": "block", "overflow": "hidden", "paddingBottom": ".12em", "marginBottom": "-.12em"}}><span data-ml data-mld="0" style={{"display": "block"}}>Marketing a trust-first business</span></span>
  </h1>
  <p data-rv data-rvd="2" style={{"fontSize": "clamp(15px,1.35vw,18px)", "lineHeight": "1.65", "margin": "clamp(20px,3vh,32px) 0 0", "maxWidth": "58ch", "color": "color-mix(in srgb, var(--color-text) 72%, transparent)"}}>In sensitive categories like gold buying, education outperforms promotion every time.</p>
</header>
<section data-screen-label="Hero media" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(32px,4vw,56px) clamp(24px,6vw,96px)"}}>
  <div data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden", "maxWidth": "520px"}}>
    <div style={{"display": "block", "aspectRatio": "3/4", "background": "var(--color-neutral-200)"}}><image-slot id="bt-hero" shape="rect" placeholder="Ahvi Gold store launch" src="work/case/ahvi-storefront.jpg"></image-slot></div>
  </div>
</section>
<article data-screen-label="Article" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(48px,6vw,90px) clamp(24px,6vw,96px)"}}>
  <div style={{"maxWidth": "820px"}}>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "0 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>01</span>Show the process</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>Trust grows when nothing is hidden. Filming purity testing and valuation step by step answers the question every customer quietly asks: will I be treated fairly?</p>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "40px 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>02</span>Answer the awkward questions</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>The doubts people don’t voice are the ones that stop them. Content that names hesitations directly, such as pricing, safety and paperwork, converts skeptics into walk-ins.</p>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "40px 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>03</span>Look as professional as you are</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>In finance-adjacent categories, design is credibility. Clean typography, consistent colors and calm language signal an organised business before a word is read.</p>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "40px 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>04</span>Local proof matters</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>Familiar locations and real customer moments beat generic stock. People trust businesses that clearly exist in their city.</p>
    <div data-rv style={{"marginTop": "44px", "borderTop": "2px solid var(--color-accent)", "background": "var(--color-surface)", "padding": "clamp(20px,2.6vw,32px)"}}>
      <div style={{"fontSize": "11px", "letterSpacing": ".22em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)", "marginBottom": "12px"}}>Quick takeaways</div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Film the process, not claims</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Publish answers to real objections</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Keep the visual identity consistent</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Anchor content in your city</span></div>
    </div>
  </div>
</article>
<section data-screen-label="Pager" style={{"borderTop": "2px solid var(--color-divider)", "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(280px,1fr))", "gap": "2px", "background": "var(--color-divider)"}}>
  <a href="blog-meta-ads.html" style={{"background": "var(--color-bg)", "textDecoration": "none", "padding": "clamp(24px,3.5vw,40px) clamp(24px,6vw,96px)", "transition": "background .3s"}} className="hv-24">
    <span style={{"display": "block", "fontSize": "11px", "letterSpacing": ".18em", "textTransform": "uppercase", "color": "color-mix(in srgb, var(--color-text) 50%, transparent)"}}>← Previous post</span>
    <span style={{"display": "block", "fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(16px,1.7vw,22px)", "letterSpacing": "-.015em", "marginTop": "8px", "color": "var(--color-text)"}}>Meta ads that drive footfall, not just likes</span>
  </a>
  <a href="blog-hoardings.html" style={{"background": "var(--color-bg)", "textDecoration": "none", "padding": "clamp(24px,3.5vw,40px) clamp(24px,6vw,96px)", "textAlign": "right", "transition": "background .3s"}} className="hv-24">
    <span style={{"display": "block", "fontSize": "11px", "letterSpacing": ".18em", "textTransform": "uppercase", "color": "color-mix(in srgb, var(--color-text) 50%, transparent)"}}>Next post →</span>
    <span style={{"display": "block", "fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(16px,1.7vw,22px)", "letterSpacing": "-.015em", "marginTop": "8px", "color": "var(--color-text)"}}>What makes a hoarding impossible to ignore</span>
  </a>
</section>
<section data-screen-label="CTA" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(48px,6vw,80px) clamp(24px,6vw,96px)", "display": "flex", "justifyContent": "space-between", "alignItems": "center", "gap": "24px", "flexWrap": "wrap"}}>
  <div style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(24px,2.8vw,40px)", "letterSpacing": "-.02em", "maxWidth": "24ch"}}>Want this working for your brand?</div>
