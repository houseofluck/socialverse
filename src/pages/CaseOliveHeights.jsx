...
<header data-screen-label="Case hero" style={{"position": "relative", "overflow": "hidden", "background": "var(--color-accent)", "color": "#14110c", "padding": "clamp(70px,9vw,140px) clamp(24px,6vw,96px)"}}>
  ...
  <div style={{"position": "relative"}}>
    ...
    <h1 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(30px,4.4vw,72px)", "lineHeight": "1.04", "letterSpacing": "-.024em", "margin": "0", "maxWidth": "22ch"}}>
      <span style={{"display": "block", "overflow": "hidden", "paddingBottom": ".12em", "marginBottom": "-.12em"}}><span data-ml data-mld="0" style={{"display": "block"}}>Make People Want To Go There.</span></span>
    </h1>
    <p data-rv data-rvd="2" style={{"fontSize": "clamp(14.5px,1.25vw,16.5px)", "lineHeight": "1.7", "margin": "clamp(20px,3vh,32px) 0 0", "maxWidth": "70ch", "opacity": ".85"}}>The brief was simple. Olive Heights is a rooftop restaurant and bar in Guwahati. Great food. Good cocktails. Rooftop views. Music. Sunset. The whole thing.</p>
  </div>
</header>
...
<section data-screen-label="Results" style={{"padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)", "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(300px,1fr))", "gap": "clamp(32px,5vw,80px)"}}>
  <div>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "0 0 18px"}}>On The Page</h2>
    <div data-rv data-rvd="1" style={{"borderTop": "2px solid var(--color-divider)"}}><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>The brand became more visible online</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Engagement improved</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>The page started communicating the experience much better</span></div></div>
  </div>
  <div>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "0 0 18px"}}>For The Business</h2>
    <div data-rv data-rvd="1" style={{"borderTop": "2px solid var(--color-divider)"}}><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>More enquiries</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>More interactions</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Support for restaurant footfall through paid campaigns</span></div></div>
  </div>
</section>
<section data-screen-label="Challenges" style={{"borderTop": "2px solid var(--color-divider)", "background": "var(--color-neutral-100)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "0 0 14px"}}>The Problem</h2>
  <p data-rv style={{"fontSize": "15px", "lineHeight": "1.7", "margin": "0 0 22px", "maxWidth": "70ch", "color": "color-mix(in srgb, var(--color-text) 75%, transparent)"}}>Instagram is full of restaurants doing the same thing. Everyone has food photos. Everyone has reels. Everyone has the “perfect ambience” shot. So we didn't want to make another restaurant page that looked nice. We wanted someone scrolling at 7 PM on a Friday to think, “Okay, we're going there tonight.”</p>
</section>
...
<section data-screen-label="Menus and festivals" style={{"borderTop": "2px solid var(--color-divider)", "background": "var(--color-neutral-100)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  ...
  <div className="gal4" style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(200px,1fr))", "gap": "clamp(14px,2vw,24px)"}}>
    ...
    <div data-case data-rv data-rvd="3" style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "#1d1a14"}}><image-slot id="oh-hoard-1" shape="rect" placeholder="Olive Heights hoarding" src="work/hoardings/olive-heights-dine-in-elegance.jpg" fit="contain"></image-slot></div></div></div>
  </div>
</section>
<section data-screen-label="Reels" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "0 0 14px"}}>Reels and Short Form</h2>
...
<section data-screen-label="Conclusion" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  ...
  <p data-rv style={{"fontSize": "15px", "lineHeight": "1.7", "margin": "0", "maxWidth": "70ch", "color": "color-mix(in srgb, var(--color-text) 78%, transparent)"}}>The goal was never to make Olive Heights look good. It already did. The goal was to make people want to experience it.</p>
</section>
