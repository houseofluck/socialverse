...
<header data-screen-label="Case hero" style={{"position": "relative", "overflow": "hidden", "background": "var(--color-accent)", "color": "#14110c", "padding": "clamp(70px,9vw,140px) clamp(24px,6vw,96px)"}}>
  ...
  <div style={{"position": "relative"}}>
    <div data-rv style={{"fontSize": "11px", "letterSpacing": ".22em", "textTransform": "uppercase", "fontWeight": "600", "opacity": ".75", "marginBottom": "clamp(18px,3vh,30px)"}}><a href="case-studies.html" style={{"color": "inherit", "textDecoration": "none"}}>Case Studies</a> · 02 / 03 · Luxury hotel, Guwahati Airport</div>
    ...
    <h1 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(30px,4.4vw,72px)", "lineHeight": "1.04", "letterSpacing": "-.024em", "margin": "0", "maxWidth": "22ch"}}>
      <span style={{"display": "block", "overflow": "hidden", "paddingBottom": ".12em", "marginBottom": "-.12em"}}><span data-ml data-mld="0" style={{"display": "block"}}>Five Seconds To Make</span></span>
      <span style={{"display": "block", "overflow": "hidden", "paddingBottom": ".12em", "marginBottom": "-.12em"}}><span data-ml data-mld="1" style={{"display": "block"}}>You Want To Stay.</span></span>
    </h1>
    <p data-rv data-rvd="2" style={{"fontSize": "clamp(14.5px,1.25vw,16.5px)", "lineHeight": "1.7", "margin": "clamp(20px,3vh,32px) 0 0", "maxWidth": "70ch", "opacity": ".85"}}>Awesome Palace is a luxury hotel near Guwahati Airport, with rooms, dining, banquets and everything you'd expect from a premium property.</p>
  </div>
</header>
...
<section data-screen-label="Creative work" style={{"borderTop": "2px solid var(--color-divider)", "background": "var(--color-neutral-100)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  ...
  <div style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(260px,1fr))", "gap": "clamp(24px,4vw,56px)", "alignItems": "center", "borderTop": "2px solid var(--color-divider)", "marginTop": "clamp(32px,4.5vw,60px)", "paddingTop": "clamp(28px,4vw,48px)"}}>
    ...
    <div>
      <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "0 0 14px"}}>Reels and Storytelling</h2>
      <p data-rv data-rvd="1" style={{"fontSize": "15px", "lineHeight": "1.7", "margin": "0", "maxWidth": "56ch", "color": "color-mix(in srgb, var(--color-text) 75%, transparent)"}}>Short form vertical films carry the property the way stills cannot: interiors, ambience and service detail cut for reach, retention and the first-second hook.</p>
    </div>
  </div>
</section>
<section data-screen-label="Conclusion" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  ...
  <p data-rv style={{"fontSize": "15px", "lineHeight": "1.7", "margin": "0", "maxWidth": "70ch", "color": "color-mix(in srgb, var(--color-text) 78%, transparent)"}}>If the property feels premium in real life, the Instagram shouldn't make it look ordinary.</p>
</section>
