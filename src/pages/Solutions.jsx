...
class Component extends DCLogic {
  renderVals() {
    ...
    const base = [
      { anchor: 's-brand', page: 'Brandsolutions.html', key: 'gold', n: '01', t: 'Brand Solutions', k: 'Make it mean something', c: 'Positioning, identity systems and campaign platforms built on research and taste. We find the one thing worth saying, then say it like we mean it.', tags: ['Positioning', 'Identity', 'Campaigns'], stat: 'Ahvi Gold', statL: 'Trust-first branding', dels: [{ t: 'Brand strategy & research', m: 'Research first' }, { t: 'Identity & design systems', m: 'Logo to guidelines' }, { t: 'Campaign platforms', m: 'Big ideas, long legs' }, { t: 'Naming & voice', m: 'Words that stick' }] },
      { anchor: 's-social', page: 'Socialsolutions.html', key: 'rose', n: '02', t: 'Social Solutions', k: 'Stop the scroll', c: 'Always-on content engines and communities run with editorial discipline. A feed that never feels like filler.', tags: ['Content engines', 'Community', 'Creators'], stat: 'Olive Heights', statL: 'Feed, reels, menus', dels: [{ t: 'Always-on content systems', m: 'Calendars to posts' }, { t: 'Community management', m: 'Clubs, not comment sections' }, { t: 'Creator & influencer', m: 'Casting to contracts' }, { t: 'Social listening', m: 'Trends before they trend' }] },
      { anchor: 's-media', page: 'Mediasolutions.html', key: 'teal', n: '03', t: 'Media Solutions', k: 'Spend like it matters', c: 'Full-funnel planning, buying and measurement. Attention treated like money — because it is.', tags: ['Planning', 'Buying', 'Analytics'], stat: 'Awesome Palace', statL: 'Meta campaigns', dels: [{ t: 'Media planning & buying', m: 'Digital + OOH' }, { t: 'Performance marketing', m: 'ROAS with receipts' }, { t: 'SEO / ASO', m: 'Found, not forced' }, { t: 'Dashboards & measurement', m: 'CFO-friendly math' }] },
      { anchor: 's-tech', page: 'Techsolutions.html', key: 'ink', n: '04', t: 'Tech Solutions', k: 'Ship it fast', c: 'Websites, apps, commerce and the design systems behind them — prototypes on Monday, production on Friday.', tags: ['Web & apps', 'Commerce', 'AI tooling'], stat: 'Web', statL: 'Websites & platforms', dels: [{ t: 'Websites & platforms', m: 'Fast and findable' }, { t: 'Apps & commerce', m: 'Load fast, sell faster' }, { t: 'Design systems', m: 'Built to survive rebrands' }, { t: 'AI pipelines', m: 'Useful, not gimmicky' }] },
      { anchor: 's-film', page: 'Filmsolutions.html', key: 'terra', n: '05', t: 'Film Solutions', k: 'Press record', c: 'Direction, production and post for reels, promos, campaigns and everything that moves.', tags: ['Direction', 'Production', 'Post'], stat: 'Reels', statL: 'Short form that does the work', dels: [{ t: 'Direction & scripting', m: 'Story first' }, { t: 'Production', m: 'In-house studio' }, { t: 'Post & motion', m: 'Edit, grade, sound' }, { t: 'Photography', m: 'Stills that sell' }] }
    ];
