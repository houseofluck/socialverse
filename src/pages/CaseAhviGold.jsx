...
<header data-screen-label="Case hero" style={{"position": "relative", "overflow": "hidden", "background": "var(--color-accent)", "color": "#14110c", "padding": "clamp(70px,9vw,140px) clamp(24px,6vw,96px)"}}>
  ...
  <div style={{"position": "relative"}}>
    <div data-rv style={{"fontSize": "11px", "letterSpacing": ".22em", "textTransform": "uppercase", "fontWeight": "600", "opacity": ".75", "marginBottom": "clamp(18px,3vh,30px)"}}><a href="case-studies.html" style={{"color": "inherit", "textDecoration": "none"}}>Case Studies</a> — 03 / 03 — Gold buying — trust-first</div>
    ...
    <h1 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(30px,4.4vw,72px)", "lineHeight": "1.04", "letterSpacing": "-.024em", "margin": "0", "maxWidth": "22ch"}}>
      <span style={{"display": "block", "overflow": "hidden", "paddingBottom": ".12em", "marginBottom": "-.12em"}}><span data-ml data-mld="0" style={{"display": "block"}}>Transforming Ahvi Gold Into A Recognizable Gold Buying Brand</span></span>
    </h1>
    <p data-rv data-rvd="2" style={{"fontSize": "clamp(14.5px,1.25vw,16.5px)", "lineHeight": "1.7", "margin": "clamp(20px,3vh,32px) 0 0", "maxWidth": "70ch", "opacity": ".85"}}>Ahvi Gold is a trusted gold and silver buying company specializing in transparent valuation, instant payments, and secure transactions for customers looking to sell their precious metals. The brand focuses on a professional, trustworthy, and hassle-free experience through accurate purity testing, fair market pricing, and customer-centric service.</p>
  </div>
</header>
...
<section data-screen-label="Objectives + Results" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)", "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(300px,1fr))", "gap": "clamp(32px,5vw,80px)"}}>
  ...
  <div>
    ...
    <div data-rv data-rvd="1" style={{"borderTop": "2px solid var(--color-divider)"}}><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Increased social media visibility and audience engagement</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Improved customer trust through educational and informative content</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Higher reach through premium reels and creative campaigns</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Increased inquiries and walk-in customers through Meta ads</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Enhanced brand positioning in the gold buying segment</span></div><div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "#1d1a14", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Better recognition among local target audiences</span></div></div>
  </div>
</section>
<section data-screen-label="Challenges" style={{"borderTop": "2px solid var(--color-divider)", "background": "var(--color-neutral-100)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  ...
  <p data-rv style={{"fontSize": "15px", "lineHeight": "1.7", "margin": "0 0 22px", "maxWidth": "70ch", "color": "color-mix(in srgb, var(--color-text) 75%, transparent)"}}>The gold and silver buying industry relies heavily on customer trust and credibility, making digital communication highly important.</p>
  <div style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(260px,1fr))", "gap": "12px"}}>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "background": "var(--color-bg)", "padding": "14px 16px", "display": "flex", "gap": "12px", "alignItems": "baseline"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "13px", "color": "var(--color-accent-700)"}}>01</span><span style={{"fontSize": "14px", "lineHeight": "1.55"}}>Building trust in a highly sensitive financial category</span></div>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "background": "var(--color-bg)", "padding": "14px 16px", "display": "flex", "gap": "12px", "alignItems": "baseline"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "13px", "color": "var(--color-accent-700)"}}>02</span><span style={{"fontSize": "14px", "lineHeight": "1.55"}}>Overcoming customer hesitation around gold selling services</span></div>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "background": "var(--color-bg)", "padding": "14px 16px", "display": "flex", "gap": "12px", "alignItems": "baseline"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "13px", "color": "var(--color-accent-700)"}}>03</span><span style={{"fontSize": "14px", "lineHeight": "1.55"}}>Differentiating the brand from traditional local buyers</span></div>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "background": "var(--color-bg)", "padding": "14px 16px", "display": "flex", "gap": "12px", "alignItems": "baseline"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "13px", "color": "var(--color-accent-700)"}}>04</span><span style={{"fontSize": "14px", "lineHeight": "1.55"}}>Simplifying technical valuation processes for audiences</span></div>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "background": "var(--color-bg)", "padding": "14px 16px", "display": "flex", "gap": "12px", "alignItems": "baseline"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "13px", "color": "var(--color-accent-700)"}}>05</span><span style={{"fontSize": "14px", "lineHeight": "1.55"}}>Driving physical footfall instead of only online engagement</span></div>
  </div>
</section>
<section data-screen-label="Strategies" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  ...
  <div style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(260px,1fr))", "gap": "clamp(14px,2vw,24px)"}}>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "display": "flex", "flexDirection": "column"}}>
      ...
      <p style={{"fontSize": "13.5px", "lineHeight": "1.6", "margin": "0", "padding": "14px 16px", "color": "color-mix(in srgb, var(--color-text) 70%, transparent)"}}>Professional visuals, premium reels and informative creatives showcasing purity testing, transparent valuation, instant payments, and a professional service environment.</p>
    </div>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "display": "flex", "flexDirection": "column"}}>
      <div style={{"background": "var(--color-surface)", "color": "var(--color-text)", "padding": "12px 16px", "display": "flex", "justifyContent": "space-between", "alignItems": "center", "gap": "10px"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "15px"}}>Educational Content Strategy</span><span style={{"fontSize": "11px", "fontWeight": "800", "opacity": ".6"}}>02</span></div>
      <p style={{"fontSize": "13.5px", "lineHeight": "1.6", "margin": "0", "padding": "14px 16px", "color": "color-mix(in srgb, var(--color-text) 70%, transparent)"}}>Content that educates audiences on how gold valuation works, purity testing technology, market-based pricing transparency, and common misconceptions.</p>
    </div>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "display": "flex", "flexDirection": "column"}}>
      <div style={{"background": "var(--color-surface)", "color": "var(--color-text)", "padding": "12px 16px", "display": "flex", "justifyContent": "space-between", "alignItems": "center", "gap": "10px"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "15px"}}>Engaging Social Media Creatives</span><span style={{"fontSize": "11px", "fontWeight": "800", "opacity": ".6"}}>03</span></div>
      <p style={{"fontSize": "13.5px", "lineHeight": "1.6", "margin": "0", "padding": "14px 16px", "color": "color-mix(in srgb, var(--color-text) 70%, transparent)"}}>A visually consistent, premium social media feed maintained to strengthen brand perception and audience trust.</p>
    </div>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "display": "flex", "flexDirection": "column"}}>
      <div style={{"background": "var(--color-surface)", "color": "var(--color-text)", "padding": "12px 16px", "display": "flex", "justifyContent": "space-between", "alignItems": "center", "gap": "10px"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "15px"}}>Reels &amp; Short Form Videos</span><span style={{"fontSize": "11px", "fontWeight": "800", "opacity": ".6"}}>04</span></div>
      <p style={{"fontSize": "13.5px", "lineHeight": "1.6", "margin": "0", "padding": "14px 16px", "color": "color-mix(in srgb, var(--color-text) 70%, transparent)"}}>Trend-driven short videos used to improve engagement, increase reach, and simplify complex information through visual storytelling.</p>
    </div>
    <div data-rv style={{"border": "2px solid var(--color-divider)", "display": "flex", "flexDirection": "column"}}>
      <div style={{"background": "var(--color-surface)", "color": "var(--color-text)", "padding": "12px 16px", "display": "flex", "justifyContent": "space-between", "alignItems": "center", "gap": "10px"}}><span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "15px"}}>Meta Advertising Campaigns</span><span style={{"fontSize": "11px", "fontWeight": "800", "opacity": ".6"}}>05</span></div>
      <p style={{"fontSize": "13.5px", "lineHeight": "1.6", "margin": "0", "padding": "14px 16px", "color": "color-mix(in srgb, var(--color-text) 70%, transparent)"}}>Targeted campaigns to increase local awareness, generate inquiries, drive store footfall, and promote trust-based messaging.</p>
    </div>
  </div>
</section>
...
<section data-screen-label="Conclusion" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  ...
  <p data-rv style={{"fontSize": "15px", "lineHeight": "1.7", "margin": "0", "maxWidth": "70ch", "color": "color-mix(in srgb, var(--color-text) 78%, transparent)"}}>Through premium visual storytelling, educational content strategies, creative social media management, and performance-driven Meta advertising campaigns, Social Verse successfully helped Ahvi Gold strengthen its digital presence and customer trust — a more professional, transparent, and recognizable brand identity.</p>
</section>
