...
<article data-screen-label="Article" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(48px,6vw,90px) clamp(24px,6vw,96px)"}}>
  <div style={{"maxWidth": "820px"}}>
    ...
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>Judge campaigns on enquiries, reservations and walk-ins. If the front desk is not busier, the dashboard does not matter.</p>
