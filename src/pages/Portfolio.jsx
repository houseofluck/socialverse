...
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-menu-4" shape="rect" placeholder="Menu design 4" src="work/menus/olive-heights-summer-cocktails.jpg"></image-slot></div></div></div></div><div id="videos" style={{"background": "var(--color-surface)", "color": "var(--color-text)", "padding": "16px clamp(24px,6vw,96px)", "display": "flex", "justifyContent": "space-between", "alignItems": "baseline", "gap": "16px", "flexWrap": "wrap", "borderTop": "2px solid var(--color-divider)"}}>
  ...
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/showreel/social-verse-showreel.mp4" poster="work/showreel/social-verse-showreel-poster.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="The Social Verse showreel" style={{"display": "block", "width": "100%", "aspectRatio": "16/9", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  ...
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-olive-heights-1.mp4" poster="work/reels/posters/reel-olive-heights-1.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Olive Heights reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-olive-garden-2.mp4" poster="work/reels/posters/reel-olive-garden-2.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Olive Garden reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-awesome-palace-rooms.mp4" poster="work/reels/posters/reel-awesome-palace-rooms.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Awesome Palace reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-ahvi-gold.mp4" poster="work/reels/posters/reel-ahvi-gold.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Ahvi Gold reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-coriander.mp4" poster="work/reels/posters/reel-coriander.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Coriander reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-fix24.mp4" poster="work/reels/posters/reel-fix24.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Fix24 reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-olive-heights-2.mp4" poster="work/reels/posters/reel-olive-heights-2.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Olive Heights reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-olive-garden.mp4" poster="work/reels/posters/reel-olive-garden.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Olive Garden reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-awesome-palace.mp4" poster="work/reels/posters/reel-awesome-palace.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Awesome Palace reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="work/reels/reel-olive-heights-3.mp4" poster="work/reels/posters/reel-olive-heights-3.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Olive Heights reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
...
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-show-16" shape="rect" placeholder="Brand post 16" src="work/creatives/creative-08.jpg"></image-slot></div></div></div></div><section style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(28px,4vw,48px) clamp(24px,6vw,96px)", "display": "flex", "gap": "14px clamp(20px,3vw,44px)", "flexWrap": "wrap", "alignItems": "baseline"}}>
  ...
  <span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(14px,1.4vw,19px)", "textTransform": "uppercase", "letterSpacing": ".04em", "color": "var(--color-neutral-700)"}}><img src="clients/olive-heights.png" alt="" style={{"height": "clamp(22px,2.4vw,32px)", "width": "auto", "objectFit": "contain", "verticalAlign": "middle", "marginRight": "10px"}} />Olive Heights</span>
  <span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(14px,1.4vw,19px)", "textTransform": "uppercase", "letterSpacing": ".04em", "color": "var(--color-neutral-700)"}}><img src="clients/olive-garden.png" alt="" style={{"height": "clamp(22px,2.4vw,32px)", "width": "auto", "objectFit": "contain", "verticalAlign": "middle", "marginRight": "10px"}} />Olive Garden</span>
  <span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(14px,1.4vw,19px)", "textTransform": "uppercase", "letterSpacing": ".04em", "color": "var(--color-neutral-700)"}}><img src="clients/awesome-palace.png" alt="" style={{"height": "clamp(22px,2.4vw,32px)", "width": "auto", "objectFit": "contain", "verticalAlign": "middle", "marginRight": "10px"}} />Awesome Palace</span>
  <span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(14px,1.4vw,19px)", "textTransform": "uppercase", "letterSpacing": ".04em", "color": "var(--color-neutral-700)"}}><img src="clients/fix24.png" alt="" style={{"height": "clamp(22px,2.4vw,32px)", "width": "auto", "objectFit": "contain", "verticalAlign": "middle", "marginRight": "10px"}} />Fix24</span>
  <span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(14px,1.4vw,19px)", "textTransform": "uppercase", "letterSpacing": ".04em", "color": "var(--color-neutral-700)"}}><img src="clients/ahvi-gold.png" alt="" style={{"height": "clamp(22px,2.4vw,32px)", "width": "auto", "objectFit": "contain", "verticalAlign": "middle", "marginRight": "10px"}} />Ahvi Gold</span>
  <span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(14px,1.4vw,19px)", "textTransform": "uppercase", "letterSpacing": ".04em", "color": "var(--color-neutral-700)"}}><img src="clients/jewellery-hub.png" alt="" style={{"height": "clamp(22px,2.4vw,32px)", "width": "auto", "objectFit": "contain", "verticalAlign": "middle", "marginRight": "10px"}} />Jewellery Hub</span>
  <span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(14px,1.4vw,19px)", "textTransform": "uppercase", "letterSpacing": ".04em", "color": "var(--color-neutral-700)"}}><img src="clients/paxmeet.png" alt="" style={{"height": "clamp(22px,2.4vw,32px)", "width": "auto", "objectFit": "contain", "verticalAlign": "middle", "marginRight": "10px"}} />Paxmeet</span>
  <span style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(14px,1.4vw,19px)", "textTransform": "uppercase", "letterSpacing": ".04em", "color": "var(--color-neutral-700)"}}><img src="clients/coriander.png" alt="" style={{"height": "clamp(22px,2.4vw,32px)", "width": "auto", "objectFit": "contain", "verticalAlign": "middle", "marginRight": "10px"}} />Coriander</span>
