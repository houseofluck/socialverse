...
<header data-screen-label="Hero" style={{"position": "relative", "overflow": "hidden", "background": "var(--color-bg)", "color": "var(--color-text)", "padding": "clamp(70px,9vw,140px) clamp(24px,6vw,96px)"}}>
  ...
  <h1 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(34px,5vw,84px)", "lineHeight": "1.02", "letterSpacing": "-.025em", "margin": "0", "maxWidth": "20ch", "color": "inherit"}}>
    <span style={{"display": "block", "overflow": "hidden", "paddingBottom": ".12em", "marginBottom": "-.12em"}}><span data-ml data-mld="0" style={{"display": "block"}}>A Showcase of Brands, Campaigns &amp; Creativity</span></span>
  </h1>
  <p data-rv data-rvd="2" style={{"fontSize": "clamp(15px,1.3vw,17px)", "lineHeight": "1.65", "margin": "clamp(20px,3vh,32px) 0 0", "maxWidth": "56ch", "opacity": ".85"}}>Designs, hoardings, tickets, films and social creatives — the work that keeps all eyes on our clients. Drop your latest pieces straight into the slots.</p>
  ...
  <h2 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.4vw,32px)", "letterSpacing": "-.015em", "margin": "0"}}>Our Creativity</h2>
  <span style={{"fontSize": "11px", "letterSpacing": ".18em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)"}}>Creative Designs Built To Capture Attention</span>
</div><div style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(240px,1fr))", "gap": "clamp(16px,2.4vw,32px)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}><div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-cre-1" shape="rect" placeholder="Creative design 1" src="work/creatives/creative-01.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-cre-2" shape="rect" placeholder="Creative design 2" src="work/creatives/creative-02.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-cre-3" shape="rect" placeholder="Creative design 3" src="work/creatives/creative-03.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-cre-4" shape="rect" placeholder="Creative design 4" src="work/creatives/creative-04.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-cre-5" shape="rect" placeholder="Creative design 5" src="work/creatives/creative-05.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-cre-6" shape="rect" placeholder="Creative design 6" src="work/creatives/creative-06.jpg"></image-slot></div></div></div></div><div id="hoardings" style={{"background": "var(--color-surface)", "color": "var(--color-text)", "padding": "16px clamp(24px,6vw,96px)", "display": "flex", "justifyContent": "space-between", "alignItems": "baseline", "gap": "16px", "flexWrap": "wrap", "borderTop": "2px solid var(--color-divider)"}}>
  <h2 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.4vw,32px)", "letterSpacing": "-.015em", "margin": "0"}}>Hoarding Designs</h2>
  <span style={{"fontSize": "11px", "letterSpacing": ".18em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)"}}>Outdoor Designs That Stand Out</span>
</div><div style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(320px,1fr))", "gap": "clamp(16px,2.4vw,32px)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}><div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/3", "background": "var(--color-neutral-200)"}}><image-slot id="pf-hoard-1" shape="rect" placeholder="Hoarding design 1" src="work/hoarding.jpg" fit="contain"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/3", "background": "var(--color-neutral-200)"}}><image-slot id="pf-hoard-2" shape="rect" placeholder="Hoarding design 2" src="hoarding-design.jpg"></image-slot></div></div></div></div><div id="tickets" style={{"background": "var(--color-surface)", "color": "var(--color-text)", "padding": "16px clamp(24px,6vw,96px)", "display": "flex", "justifyContent": "space-between", "alignItems": "baseline", "gap": "16px", "flexWrap": "wrap", "borderTop": "2px solid var(--color-divider)"}}>
  <h2 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.4vw,32px)", "letterSpacing": "-.015em", "margin": "0"}}>Ticket Designs</h2>
  <span style={{"fontSize": "11px", "letterSpacing": ".18em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)"}}>Designed To Make Every Entry Special</span>
...
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/3", "background": "var(--color-neutral-200)"}}><image-slot id="pf-ticket-3" shape="rect" placeholder="Ticket design 3" src="work/tickets/ticket-3.jpg" fit="contain"></image-slot></div></div></div></div><div id="videos" style={{"background": "var(--color-surface)", "color": "var(--color-text)", "padding": "16px clamp(24px,6vw,96px)", "display": "flex", "justifyContent": "space-between", "alignItems": "baseline", "gap": "16px", "flexWrap": "wrap", "borderTop": "2px solid var(--color-divider)"}}>
  <h2 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.4vw,32px)", "letterSpacing": "-.015em", "margin": "0"}}>Our Creative Videos</h2>
  <span style={{"fontSize": "11px", "letterSpacing": ".18em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)"}}>Visual Storytelling That Drives Engagement</span>
  ...
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="uploads/reel-landscape.mp4" autoPlay muted loop playsInline preload="metadata" aria-label="Creative video 1" style={{"display": "block", "width": "100%", "aspectRatio": "16/9", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="uploads/case-halka.mp4" autoPlay muted loop playsInline preload="metadata" aria-label="Creative video 2" style={{"display": "block", "width": "100%", "aspectRatio": "16/9", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  <div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><video data-auto src="showreel.mp4" poster="showreel-poster.jpg" autoPlay muted loop playsInline preload="metadata" aria-label="The Social Verse showreel" style={{"display": "block", "width": "100%", "aspectRatio": "16/9", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video></div></div>
  ...
  <span style={{"fontSize": "11px", "letterSpacing": ".18em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)"}}>Short-Form Video That Stops The Scroll</span>
</div><div style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(200px,1fr))", "gap": "clamp(16px,2.4vw,32px)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}>
  ...
  <h2 style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.4vw,32px)", "letterSpacing": "-.015em", "margin": "0"}}>Social Media Creatives</h2>
  <span style={{"fontSize": "11px", "letterSpacing": ".18em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)"}}>Creatives Designed To Stop The Scroll</span>
</div><div style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(200px,1fr))", "gap": "clamp(16px,2.4vw,32px)", "padding": "clamp(56px,7vw,110px) clamp(24px,6vw,96px)"}}><div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-social-1" shape="rect" placeholder="Social creative 1" src="work/creatives/creative-07.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-social-2" shape="rect" placeholder="Social creative 2" src="work/creatives/creative-08.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-social-3" shape="rect" placeholder="Social creative 3" src="work/creatives/creative-09.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-social-4" shape="rect" placeholder="Social creative 4" src="work/creatives/showcase-01.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-social-5" shape="rect" placeholder="Social creative 5" src="work/creatives/showcase-02.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-social-6" shape="rect" placeholder="Social creative 6" src="work/creatives/showcase-03.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-social-7" shape="rect" placeholder="Social creative 7" src="work/creatives/showcase-05.jpg"></image-slot></div></div></div>
<div data-case data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}><div data-zoom style={{"transition": "transform 1.3s cubic-bezier(.22,1,.36,1)"}}><div style={{"aspectRatio": "4/5", "background": "var(--color-neutral-200)"}}><image-slot id="pf-social-8" shape="rect" placeholder="Social creative 8" src="work/creatives/showcase-07.jpg"></image-slot></div></div></div></div><section style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(28px,4vw,48px) clamp(24px,6vw,96px)", "display": "flex", "gap": "14px clamp(20px,3vw,44px)", "flexWrap": "wrap", "alignItems": "baseline"}}>
  ...
  <div style={{"position": "relative", "aspectRatio": "21/8", "minHeight": "340px", "background": "var(--color-neutral-200)"}}><image-slot id="cta-team" shape="rect" placeholder="Drop a photo of people working" src="showreel-poster.jpg"></image-slot></div>
