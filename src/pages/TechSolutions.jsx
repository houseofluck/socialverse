...
class Component extends DCLogic {
  renderVals() {
    const SOL = {"n":"04","title":"Tech Solutions","k":"Ship it fast","c":"Websites, apps, commerce and the design systems behind them — prototypes on Monday, production on Friday.","tags":["Web & apps","Commerce","Design systems","AI tooling"],"dels":[{"t":"Websites & platforms","m":"Fast and findable"},{"t":"Apps & commerce","m":"Load fast, sell faster"},{"t":"Design systems","m":"Built to survive rebrands"},{"t":"AI pipelines","m":"Useful, not gimmicky"}],"steps":[{"n":"01","t":"Prototype Monday","d":"A clickable answer to the brief inside the first week."},{"n":"02","t":"Build in sprints","d":"Design and engineering at the same desk, shipping every fortnight."},{"n":"03","t":"Launch & measure","d":"Performance budgets, analytics and a roadmap that survives contact."}],"stat":"90s","statL":"Fastest onboarding built","prevT":"Media Solutions","prevHref":"Mediasolutions.html","nextT":"Film Solutions","nextHref":"Filmsolutions.html"};
    return {
      ...SOL,
      megaLinks: [
