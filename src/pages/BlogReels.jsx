...
<header data-screen-label="Post hero" style={{"padding": "clamp(64px,8vw,120px) clamp(24px,6vw,96px) clamp(36px,4.5vw,56px)"}}>
  <div data-rv style={{"fontSize": "11px", "letterSpacing": ".22em", "textTransform": "uppercase", "fontWeight": "600", "color": "var(--color-accent-700)", "marginBottom": "clamp(18px,3vh,30px)"}}><a href="blog.html" style={{"color": "inherit", "textDecoration": "none"}}>The Blog</a> · Social · Aug '26  min read</div>
  ...
  <p data-rv data-rvd="2" style={{"fontSize": "clamp(15px,1.35vw,18px)", "lineHeight": "1.65", "margin": "clamp(20px,3vh,32px) 0 0", "maxWidth": "58ch", "color": "color-mix(in srgb, var(--color-text) 72%, transparent)"}}>Short-form video sells the feeling, and the feeling sells the table.</p>
</header>
  ...
  <div style={{"maxWidth": "820px"}}>
    <div style={{"display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(160px,1fr))", "gap": "clamp(12px,1.6vw,20px)"}}>
      <div data-rv style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}>
        <video data-auto src="work/reels/reel-olive-garden-2.mp4" poster="work/reels/posters/reel-olive-garden-2.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Olive Garden reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video>
      </div>
      <div data-rv data-rvd="1" style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}>
        <video data-auto src="work/reels/reel-olive-heights-1.mp4" poster="work/reels/posters/reel-olive-heights-1.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Olive Heights reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video>
      </div>
      <div data-rv data-rvd="2" style={{"border": "2px solid var(--color-divider)", "overflow": "hidden"}}>
        <video data-auto src="work/reels/reel-olive-heights-2.mp4" poster="work/reels/posters/reel-olive-heights-2.jpg" autoPlay={vals.vidAuto} muted loop playsInline preload={vals.vidAuto ? 'metadata' : 'none'} aria-label="Olive Heights reel" style={{"display": "block", "width": "100%", "aspectRatio": "9/16", "objectFit": "cover", "background": "var(--color-neutral-200)"}}></video>
      </div>
    </div>
...
<article data-screen-label="Article" style={{"borderTop": "2px solid var(--color-divider)", "padding": "clamp(48px,6vw,90px) clamp(24px,6vw,96px)"}}>
  <div style={{"maxWidth": "820px"}}>
    ...
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>Most people check the grid before they book. Alternate dishes, people and ambience so a ten-second scroll answers what it looks like, what to order, and how it feels.</p>
    <h2 data-rv style={{"fontFamily": "var(--font-heading)", "fontWeight": "800", "fontSize": "clamp(20px,2.2vw,30px)", "letterSpacing": "-.015em", "margin": "40px 0 14px"}}><span style={{"color": "var(--color-accent-700)", "fontVariantNumeric": "tabular-nums", "marginRight": "12px"}}>04</span>Turn views into visits</h2>
    <p data-rv style={{"fontSize": "16px", "lineHeight": "1.75", "margin": "0", "maxWidth": "68ch", "color": "color-mix(in srgb, var(--color-text) 82%, transparent)"}}>End reels with a reason to move: a weekend event, a seasonal dish, a table link pinned in bio. Pair the organic winners with a small Meta boost to reach nearby diners.</p>
    <div data-rv style={{"marginTop": "44px", "borderTop": "2px solid var(--color-accent)", "background": "var(--color-surface)", "padding": "clamp(20px,2.6vw,32px)"}}>
      ...
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Shoot vertical at golden hour</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Hook in the first 1.5 seconds</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Caption for cravings, not descriptions</span></div>
      <div style={{"display": "flex", "gap": "12px", "padding": "12px 4px", "borderBottom": "2px solid var(--color-divider)", "alignItems": "baseline"}}><span style={{"width": "10px", "height": "10px", "background": "var(--color-accent)", "flex": "none"}}></span><span style={{"fontSize": "14.5px", "lineHeight": "1.55"}}>Boost winners to a 5 km radius</span></div>
    </div>
  </div>
</article>
<section data-screen-label="Pager" style={{"borderTop": "2px solid var(--color-divider)", "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(280px,1fr))", "gap": "2px", "background": "var(--color-divider)"}}>
  <a href="blog-grid.html" style={{"background": "var(--color-bg)", "textDecoration": "none", "padding": "clamp(24px,3.5vw,40px) clamp(24px,6vw,96px)", "transition": "background .3s"}} className="hv-24">
  ...
  <a href="blog-meta-ads.html" style={{"background": "var(--color-bg)", "textDecoration": "none", "padding": "clamp(24px,3.5vw,40px) clamp(24px,6vw,96px)", "textAlign": "right", "transition": "background .3s"}} className="hv-24">
